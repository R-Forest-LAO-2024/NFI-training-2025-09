...
<!-- FOR PUBLICATION run in terminal: -->

<!-- quarto render main-training-report.qmd -->

<!-- quarto publish gh-pages main-training-report.qmd -->
...
The workshop agenda and participants list are shown in @fig-agenda1.
...
Before loading the data and perform the analysis with [R](https://www.r-project.org/) and [Rstudio](https://posit.co/download/rstudio-desktop/), we need to prepare the environment by loading packages and setting a few options. Here we don't load directly packages, but we source a script that load them.
...
-   **2-phases designs produce both areas and forest characteristics, which makes final estimates generally more robust than NFIs with one sampling and independent land cover maps (**[Westfall et al. 2019](https://www.fs.usda.gov/nrs/pubs/jrnl/2019/nrs_2019_westfall_001.pdf)**).**
...
![Plot design of Lao PDR NFI cycle 4. (A) Plot design, (B) subplot design and (C) land cover observation points and land cover sections.](img/plot-design.png)
...
![Core measurements for carbon. (A) Live tree measurements, (B) standing dead tree measurement, (C) Lying deadwood measurement, (D) stump measurement.](img/core-meas.png)
...
1.  **Setup** the R environment (inc. loading NFI and ancillary data)

2.  Prepare **clean** data (clean, correct and join)

3.  **Calculate entity** level variables

4.  **Aggregate** measurements to minimal measurement area, plot, strata and totals
...
![Detailed calculation steps.](img/calc-steps.png)
...
![List of analytical R scripts.](img/list-scripts.png)
...
![Tree density at forest stand](img/refresher-tree-density.png)
...
2.  Calculate the mean aboveground biomass for all forest types using **ratio estimators** and **2-phases sampling for post-stratification**.
3.  Compare estimates.
...
## AGB with ratio estimator and 2-phases sampling for post-stratification
...
#### (NOTE) Investigating phase 2 plots in stratum 4: non-forest
...
# Session 10: Building a R community of practice in Lao PDR
...
# ANNEX: Agenda {.unnumbered}

![Agenda part 1](img/agenda1.png){#fig-agenda1}

![Agenda part 2](img/agenda2.png){#fig-agenda2}
...
# ANNEX: participants list {.unnumbered}
