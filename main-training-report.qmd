...
The NFI cycle 4 of LAO PDR was based on an updated sampling methodology, with a **double-stage sampling for post-stratification and ratio estimators**. This session went over the core part of the NFI design and calculations for carbon related variables.

<!-- Section 2.1 -->

## Sampling design

The field plot design was based on a systematic grid of 12 by 18 km. However the following additions prevent

The main design changes for the NFI cycle 4 were:

-   the addition of a first phase with visual observation of land cover at plot center on an intense grid of 6 by 6 km, and
