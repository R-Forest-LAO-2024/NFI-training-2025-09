...
The plot design was also updated from the NFI previous cycles, where the subplots where placed randomly within a designated area. In the cycle 4 design, plots are composed by 4 circular subplots in a L shape, with 60 m between subplot centers. Subplots are nested circles of 8 and 16 m radius for trees between 10 and 30 cm DBH (30 excluded) and trees bigger or equal to 30 cm DBH respectively.

![Plot design of Lao PDR NFI cycle 4. (A) Plot design, (B) subplot design and (C) land cover observation and land cover sections.](img/plot-design.png)
